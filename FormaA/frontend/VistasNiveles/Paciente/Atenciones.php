        ...
        <div id="contenido">
            ...
            <header id="top">
                <div id="Perfil">
                    Bienvenido/a: <label id="nomPer">
                        ...
                        ?></label>
                    <input id="rutPer" class="nvl" value="
                    <?php
                    if (isset($_SESSION["personaRut"])) {
                        echo $_SESSION["personaRut"];
                    }
                    ?>" />
            ...
            <center>
                <div id="contenedor" class="contenedor">
                    <center>
                        <label>Consultar por Numero de atención o todas(Dejar el texto en blanco): </label><input type="text" name="nAtencionLP"/>
                        <button name="ListarAtenPacien">Listar Atenciones</button>

                        <div class="listarAtencionesPersona">
                        </div>
                    </center>
                </div>
            </center>
