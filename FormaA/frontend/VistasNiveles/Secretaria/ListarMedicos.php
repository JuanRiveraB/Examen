...
<html>
    <head>
        ...
        <script src="../../js/ListarMedicos.js" type="text/javascript"></script>
        ...
        <div id="contenido">
            ...
            <center>
                <div id="contenedor" class="contenedor">
                    <center>
                        <label>Consultar por Rut de Medico o todos(Dejar el texto en blanco): </label><input type="text" id="rutMedicoLis" name="rutMedicoL"/>
                        <button name="ListarMedicoSec">Listar Medicos</button>

                        <div class="ListarMedicos">
                        </div>
                    </center>
                </div>
            </center>
